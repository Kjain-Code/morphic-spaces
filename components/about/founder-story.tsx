 ...
 * portrait reveals behind a clay-colored panel that wipes away on scroll,
 * rather than a plain fade — a small, one-time moment of drama.
 */
export function FounderStory() {
  const prefersReducedMotion = useReducedMotion();

  return (
    <section className="border-t border-[var(--espresso-10)] bg-[var(--linen)] px-6 py-24 sm:px-10 sm:py-32 lg:py-40">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-20">
        <div className="lg:col-span-5">
          <div className="relative aspect-[3/4] w-full overflow-hidden bg-[var(--espresso)]">
            {/*
            ...
            */}
            ...
            <motion.div
              ...
              className="absolute inset-0 bg-[var(--clay)]"
            />
          </div>
          <motion.div
            ...
            className="mt-6 flex items-baseline justify-between border-t border-[var(--espresso-10)] pt-5"
          >
            <span className="font-serif text-xl font-light text-[var(--espresso)]">Kunal</span>
            <span className="text-[11px] uppercase tracking-[0.25em] text-[var(--espresso-muted)]">
        ...
        <div className="lg:col-span-7 lg:pt-4">
          ...
          >
            ...
            <h2 className="mt-6 max-w-xl font-serif text-3xl font-light leading-[1.2] text-[var(--espresso)] sm:text-4xl">
              It began with a different way of seeing space.
            </h2>
            <p className="mt-6 max-w-xl text-base leading-relaxed text-[var(--espresso-muted)]">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-[var(--espresso-muted)]">
          ...
          <motion.ul
            ...
            className="mt-10 flex flex-col gap-3 border-l-2 border-[var(--clay)] pl-6"
          >
            {FRAGMENTS.map((fragment) => (
              <motion.li
                ...
                className="font-serif text-lg italic font-light text-[var(--espresso)] sm:text-xl"
              >
                {fragment}
              </motion.li>
            ))}
          ...
          <motion.p
            ...
            className="mt-6 max-w-xl text-base leading-relaxed text-[var(--espresso-muted)]"
          >
            It is often these subtle elements that give a space its lasting character.
          </motion.p>

          <div className="mt-14 border-t border-[var(--espresso-10)] pt-10">
            <AnimatedQuote
              lines={["We are not here to follow a language.", "We are here to create one."]}
              className="font-serif text-2xl font-light leading-snug text-[var(--espresso)] sm:text-3xl"
            />
          </div>
        </div>
      </div>
